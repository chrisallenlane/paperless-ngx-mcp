...
func TestDeleteCustomField_Execute(t *testing.T) {
...
func TestDeleteCustomField_Execute_InvalidID(t *testing.T) {
...
func TestDeleteCustomField_Execute_NegativeID(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCustomField(c)
...
func TestDeleteCustomField_Execute_ServerError(t *testing.T) {
	server := httptest.NewServer(
		http.HandlerFunc(
...
func TestDeleteCustomField_Description(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCustomField(c)
...
func TestDeleteCustomField_InputSchema(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCustomField(c)
