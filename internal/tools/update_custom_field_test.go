...
func TestUpdateCustomField_Execute_InvalidID(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewUpdateCustomField(c)
...
func TestUpdateCustomField_Execute_ServerError(t *testing.T) {
	server := httptest.NewServer(
		http.HandlerFunc(
...
func TestUpdateCustomField_Description(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewUpdateCustomField(c)
...
func TestUpdateCustomField_InputSchema(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewUpdateCustomField(c)
