...
func TestDeleteCorrespondent_Execute(t *testing.T) {
...
func TestDeleteCorrespondent_Execute_InvalidID(t *testing.T) {
...
func TestDeleteCorrespondent_Execute_NegativeID(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCorrespondent(c)
...
func TestDeleteCorrespondent_Execute_ServerError(t *testing.T) {
	server := httptest.NewServer(
		http.HandlerFunc(
...
func TestDeleteCorrespondent_Description(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCorrespondent(c)
...
func TestDeleteCorrespondent_InputSchema(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteCorrespondent(c)
