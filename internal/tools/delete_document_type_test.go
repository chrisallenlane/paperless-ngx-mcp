...
func TestDeleteDocumentType_Execute(t *testing.T) {
...
func TestDeleteDocumentType_Execute_InvalidID(t *testing.T) {
...
func TestDeleteDocumentType_Execute_NegativeID(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteDocumentType(c)
...
func TestDeleteDocumentType_Execute_ServerError(t *testing.T) {
	server := httptest.NewServer(
		http.HandlerFunc(
...
func TestDeleteDocumentType_Description(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteDocumentType(c)
...
func TestDeleteDocumentType_InputSchema(t *testing.T) {
	c := client.New("http://localhost", "test-token")
	tool := NewDeleteDocumentType(c)
