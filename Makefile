...
# release binaries
releases :=                                        \
	$(dist_dir)/paperless-ngx-mcp-darwin-amd64     \
	$(dist_dir)/paperless-ngx-mcp-darwin-arm64     \
	$(dist_dir)/paperless-ngx-mcp-linux-386        \
	$(dist_dir)/paperless-ngx-mcp-linux-amd64      \
	$(dist_dir)/paperless-ngx-mcp-linux-arm5       \
	$(dist_dir)/paperless-ngx-mcp-linux-arm6       \
	$(dist_dir)/paperless-ngx-mcp-linux-arm7       \
	$(dist_dir)/paperless-ngx-mcp-linux-arm64      \
	$(dist_dir)/paperless-ngx-mcp-netbsd-amd64     \
	$(dist_dir)/paperless-ngx-mcp-openbsd-amd64    \
	$(dist_dir)/paperless-ngx-mcp-solaris-amd64    \
	$(dist_dir)/paperless-ngx-mcp-windows-amd64.exe
...
# paperless-ngx-mcp-darwin-amd64
$(dist_dir)/paperless-ngx-mcp-darwin-amd64:
	GOARCH=amd64 GOOS=darwin \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-darwin-arm64
$(dist_dir)/paperless-ngx-mcp-darwin-arm64:
	GOARCH=arm64 GOOS=darwin \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-386
$(dist_dir)/paperless-ngx-mcp-linux-386:
	GOARCH=386 GOOS=linux \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-amd64
$(dist_dir)/paperless-ngx-mcp-linux-amd64:
	GOARCH=amd64 GOOS=linux \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-arm5
$(dist_dir)/paperless-ngx-mcp-linux-arm5:
	GOARCH=arm GOOS=linux GOARM=5 \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-arm6
$(dist_dir)/paperless-ngx-mcp-linux-arm6:
	GOARCH=arm GOOS=linux GOARM=6 \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-arm7
$(dist_dir)/paperless-ngx-mcp-linux-arm7:
	GOARCH=arm GOOS=linux GOARM=7 \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-linux-arm64
$(dist_dir)/paperless-ngx-mcp-linux-arm64:
	GOARCH=arm64 GOOS=linux \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-netbsd-amd64
$(dist_dir)/paperless-ngx-mcp-netbsd-amd64:
	GOARCH=amd64 GOOS=netbsd \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-openbsd-amd64
$(dist_dir)/paperless-ngx-mcp-openbsd-amd64:
	GOARCH=amd64 GOOS=openbsd \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-solaris-amd64
$(dist_dir)/paperless-ngx-mcp-solaris-amd64:
	GOARCH=amd64 GOOS=solaris \
	$(GO) build $(BUILD_FLAGS) -o $@ $(cmd_dir) && $(GZIP) $@ && chmod -x $@.gz

# paperless-ngx-mcp-windows-amd64
$(dist_dir)/paperless-ngx-mcp-windows-amd64.exe:
